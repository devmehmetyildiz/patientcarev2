...
export default class Periods extends Component {
  ...
  render() {
    ...
    const { Periods, DeletePeriods, Profile } = this.props
        ...
        <React.Fragment>
          <div className='w-full h-[calc(100vh-59px-2rem)] mx-auto flex flex-col  justify-start items-center pb-[2rem] px-[2rem]'>
            ...
            {list.length > 0 ?
              ...
              </div> : <NoDataScreen message="Tanımlı Kontrol periyodu Yok" />
            }
          </div>
          <Modal
          ...
          >
            <Modal.Header>Kontrol Periyodu Silme</Modal.Header>
            <Modal.Content image>
              <Modal.Description>
                <p>
            ...
            <Modal.Actions>
              ...
              <Button
                ...
                icon='checkmark'
                onClick={() => {
                  DeletePeriods(this.state.selectedrecord)
