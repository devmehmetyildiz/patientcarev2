...
export class RolesCreate extends Component {
    ...
    componentDidMount() {
        const { AddRoles, GetAuthories, GetAuthorygroups } = this.props
        GetAuthories()
        GetAuthorygroups()
    }

    render() {
        const { AddRoles, GetAuthories, Roles, removenotification } = this.props
        const { list, notifications, authories, selected_record, authorygroups } = Roles
    ...
    handleSubmit = (e) => {
        ...
        const { AddRoles, history } = this.props
